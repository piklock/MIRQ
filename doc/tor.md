...
```
./mrqd -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:989
```

In a typical situation, this suffices to run behind a Tor proxy:
```
./mrqd -proxy=127.0.0.1:9050
```
...
-externalip=X   You can tell mrq about its publicly reachable address using
                ...
                /var/lib/tor/mrq-service/hostname. Onion addresses are given
...
```
./mrqd -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -listen
```
...
```
./mrqd -onion=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -discover
```
