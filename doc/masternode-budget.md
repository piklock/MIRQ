...
Mrq now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<mrq_address\> \<monthly_payment_mrq\> [use_ix(true|false)]
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<mrq_address\> \<monthly_payment_mrq\> \<collateral_hash\>
 ...
 * vote-many          - Vote on a Mrq initiative
 * vote-alias         - Vote on a Mrq initiative
 * vote               - Vote on a Mrq initiative/budget
