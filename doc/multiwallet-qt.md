...
In order to support loading of multiple wallets in mrq-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mrq.cpp.
...
Changes to mrq.cpp
----------------------
mrq.cpp is the entry point into mrq-qt, and as such, will require some minor modifications to provide hooks for
