...
The Mrq project operates an open contributor model where anyone is
...
The following applies to code changes to the Mrq project, and is not to be
confused with overall MRQ Network Protocol consensus changes.

Whether a pull request is merged into Mrq rests with the project merge
...
The project leader is the release manager for each Mrq release.
