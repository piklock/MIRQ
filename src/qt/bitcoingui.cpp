...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mrq: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Mrq"), this);
    aboutAction->setStatusTip(tr("Show information about Mrq"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Mrq help message to get a list with possible MRQ command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Mrq client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Mrq"); // default title
