...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Mrq features */
        {"mrq", "masternode", &masternode, true, true, false},
        {"mrq", "listmasternodes", &listmasternodes, true, true, false},
        {"mrq", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mrq", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mrq", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mrq", "masternodedebug", &masternodedebug, true, true, false},
        {"mrq", "startmasternode", &startmasternode, true, true, false},
        {"mrq", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mrq", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mrq", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mrq", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mrq", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mrq", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mrq", "mnbudget", &mnbudget, true, true, false},
        {"mrq", "preparebudget", &preparebudget, true, true, false},
        {"mrq", "submitbudget", &submitbudget, true, true, false},
        {"mrq", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mrq", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mrq", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mrq", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mrq", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mrq", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mrq", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mrq", "checkbudgets", &checkbudgets, true, true, false},
        {"mrq", "mnsync", &mnsync, true, true, false},
        {"mrq", "spork", &spork, true, true, false},
        {"mrq", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mrq", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use mrqd, or the -server option to mrq-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mrq-cli " + methodname + " " + args + "\n";
}
